				...
				<ul id="navigation" >
				 <li class="active">
						<a>
							...
							<span class="menu-mid">Ver Servicio</span>
		...
		<form action="acciones.php" method="post">
         <tbody>
		  ...
		  <tr>
		    <td>Precio</td>
		    <td>:</td>
		    <td><span id="sprytextfield5"><input name="text2" type="text" class="edit" id="text3"  value="<?php print($row[3]);?>" disabled="disabled"/>
		      <span class="textfieldRequiredMsg">Valor requerido.</span></span></td>
		    </tr>
	      <tr>
	        <td>&nbsp;</td>
